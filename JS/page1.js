    ...
    for (let i = 0; i < questions.length; i++) {
        ...
        <span class="rowDeColumns">
            <div class="answersColumn">
                <div class="answer ${questions[i].answers[0].isCorrectAnswer}" onclick="answerChoose(this)">
                    <img src="${questions[i].answers[0].image}" alt="Não foi possível carregar a imagem.">
                    <div class="nonChoiced hide"></div>
                    <p>${questions[i].answers[0].text}</p>
                </div>
            ...
            <div class="answersColumn">
                <div class="answer ${questions[i].answers[2].isCorrectAnswer}" onclick="answerChoose(this)">
                    <img src="${questions[i].answers[2].image}" alt="" >
                    <div class="nonChoiced hide"></div>
                    <p class="">${questions[i].answers[2].text}</p>
                </div>
                <div class="answer ${questions[i].answers[3].isCorrectAnswer}" onclick="answerChoose(this)">
                    <img src="${questions[i].answers[3].image}" alt="" >
                    <div class="nonChoiced hide"></div>
                    <p class="">${questions[i].answers[3].text}</p>
                </div>
            </div>
        </span>
