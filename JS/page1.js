    ...
    for (let i = 0; i < response.data.questions.length; i++){
        ...
        <span class="rowDeColumns">
            <div class="answersColumn">
                <div class="answer ${response.data.questions[0].answers[0].isCorrectAnswer}" onclick="answerChoose(this)">
                    <img src="${response.data.questions[0].answers[0].image}" alt="Não foi possível carregar a imagem.">
                    <div class="nonChoiced hide"></div>
                    <p>${response.data.questions[0].answers[0].text}</p>
                </div>
                <div class="answer ${response.data.questions[0].answers[1].isCorrectAnswer}" onclick="answerChoose(this)">
                    <img src="${response.data.questions[0].answers[1].image}" alt="">
                    <div class="nonChoiced hide"></div>
                    <p class="">${response.data.questions[0].answers[1].text}</p>
                </div>
            </div>
            <div class="answersColumn">
                <div class="answer ${response.data.questions[0].answers[1].isCorrectAnswer}" onclick="answerChoose(this)">
